...
### Name: fit_hbd_psr_on_best_grid_size
### Title: Fit pulled speciation rates of birth-death models on a time grid
###   with optimal size.
### Aliases: fit_hbd_psr_on_best_grid_size
...
##D 
##D # Fit PSR on grid, with the grid size chosen automatically between 1 and 5
##D fit = fit_hbd_psr_on_best_grid_size(tree, 
##D                                     max_PSR           = 100,
##D                                     grid_sizes        = c(1:5),
##D                                     exhaustive        = FALSE,
...
##D   PSR_fun = approxfun(x=best_fit$age_grid, y=best_fit$fitted_PSR)
##D }
## End(Not run)
