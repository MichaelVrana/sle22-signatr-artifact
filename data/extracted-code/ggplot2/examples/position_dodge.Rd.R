...
## No test: 
##D ggplot(diamonds, aes(price, fill = cut)) +
##D   geom_histogram(position="dodge2")
##D # see ?geom_bar for more examples
##D 
##D # In this case a frequency polygon is probably a better choice
##D ggplot(diamonds, aes(price, colour = cut)) +
##D   geom_freqpoly()
## End(No test)
